...
# Configuration
BASE_URL = "https://explore-wannago.preview.emergentagent.com/api"
...
class FittrAPITester:
    ...
    def test_user_authentication(self):
        ...
        try:
            ...
            session_response = self.session.get(f"https://explore-wannago.preview.emergentagent.com/api/auth/session")
            ...
            csrf_response = self.session.get(f"https://explore-wannago.preview.emergentagent.com/api/auth/csrf")
            csrf_token = None
            ...
            form_data = {
                ...
                'callbackUrl': 'https://explore-wannago.preview.emergentagent.com/dashboard',
                'json': 'true'
            }
            
            # Try signin with proper form encoding
            signin_response = self.session.post(
                f"https://explore-wannago.preview.emergentagent.com/api/auth/callback/credentials",
                data=form_data,
                headers={
            ...
            if signin_response.status_code == 200 or has_session_cookie:
                ...
                verify_response = self.session.get(f"https://explore-wannago.preview.emergentagent.com/api/auth/session")
